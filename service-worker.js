const CACHE_NAME = 'vitanusa-ai-pwa-v3';
...
const APP_SHELL = [
  ...
  `${BASE_PATH}/assets/css/nusa-app-shell.css?v=20260709-pwa-keyboard-chat-v2`,
  `${BASE_PATH}/assets/css/vitanusa-public.css`,
  `${BASE_PATH}/assets/js/main.js?v=20260709-pwa-keyboard-chat-v2`,
