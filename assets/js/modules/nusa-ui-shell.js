...
function injectShellStyles() {
  ...
  style.textContent = `
    ...
    .vn-right-rail{position:fixed;top:16px;right:16px;bottom:16px;z-index:120;width:min(328px,calc(100vw - 32px));display:flex;flex-direction:column;gap:12px;padding:14px;border:1px solid var(--vn-shell-line);border-radius:28px;background:rgba(255,255,255,.94);box-shadow:0 24px 70px rgba(20,83,45,.13);backdrop-filter:blur(18px);overflow:auto;}
    ...
    .vn-shell-toggle{position:fixed;right:14px;bottom:14px;z-index:130;display:none;align-items:center;gap:8px;min-height:44px;padding:10px 13px;border:1px solid var(--vn-shell-line);border-radius:999px;background:#fff;color:var(--vn-shell-green);font-weight:850;box-shadow:0 16px 34px rgba(20,83,45,.16);}
