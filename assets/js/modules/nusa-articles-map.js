...
export const NUSA_ARTICLE_MAP = Object.freeze([
  ...
  },
  {
    ...
    keywords: ['kebiasaan sehat', '7 hari', 'hidup sehat', 'pola hidup', 'rutinitas', 'mulai hidup sehat', 'mau mulai hidup sehat', 'langkah kecil', 'habit sehat', 'kebiasaan sehat 7 hari', 'rutinitas sehat 7 hari', 'mulai kebiasaan sehat', 'mulai dari mana hidup sehat', 'menjaga kesehatan', 'cara menjaga kesehatan', 'bagaimana cara menjaga kesehatan', 'menjaga kesehatan tubuh', 'tubuh sehat', 'agar tubuh sehat', 'supaya tubuh sehat', 'tips sehat', 'tips hidup sehat', 'tips sehat sehari hari', 'tips sehat sehari-hari', 'cara hidup sehat', 'hidup lebih sehat', 'kesehatan harian', 'kesehatan tubuh', 'menjaga badan', 'badan sehat', 'pola sehat', 'kebiasaan sehat sehari hari', 'kebiasaan sehat sehari-hari', 'apa yang harus dilakukan supaya sehat', 'bagaimana agar tetap sehat', 'langkah menjaga kesehatan', 'mulai menjaga kesehatan', 'langkah awal hidup sehat'],
  ...
  },
  {
    ...
    category: 'Kebiasaan Sehat',
    keywords: ['tidur', 'energi', 'lelah', 'kurang tidur', 'begadang', 'fokus', 'mood', 'susah tidur', 'capek', 'tidur berantakan', 'sering lelah', 'jam tidur', 'energi harian', 'tidak mudah lelah', 'mudah lelah', 'menjaga energi', 'tubuh lelah', 'badan cepat lelah'],
  ...
  },
  {
    ...
    keywords: ['sehat itu amanah', 'pola hidup sehat', 'pola hidup', 'gaya hidup sehat', 'hidup sehat', 'hidup sehat sebagai amanah', 'kebiasaan sehat', 'kebiasaan kecil', 'amanah tubuh', 'tubuh amanah', 'menjaga tubuh', 'merawat tubuh', 'menjaga kesehatan', 'menjaga kesehatan tubuh', 'merawat badan', 'merawat kesehatan', 'halal thayyib', 'halal-thayyib', 'ikhtiar sehat', 'tawakal sehat', 'tidur cukup', 'makan seimbang', 'pola makan', 'minum air', 'gerak ringan', 'olahraga ringan'],
